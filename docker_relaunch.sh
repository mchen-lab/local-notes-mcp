...
TAG="dev"
DELETE_VOLUME=false
CONTAINER_NAME="local-notes-mcp"
PORT=31111
VOLUME="local_notes_mcp_data"
...
IMAGE="ghcr.io/mchen-lab/local-notes-mcp:$TAG"
...
if [ "$DELETE_VOLUME" = true ]; then
    ...
    echo "   This will PERMANENTLY ERASE all notes and settings in the container."
